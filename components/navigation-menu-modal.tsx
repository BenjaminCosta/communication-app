...
const NAV_ITEMS: {
  ...
  },
  {
    ...
    iconClass: "text-blue-500 bg-blue-950/30 border-blue-700/35",
    glowClass: "hover:border-blue-700/45 hover:bg-blue-950/36",
    activeClass: "border-blue-700/55 bg-blue-950/40 shadow-[inset_0_1px_0_rgba(255,255,255,0.12),0_16px_38px_rgba(29,78,216,0.22)]",
