...
export function OutlookActionBar({ actions }: { actions: OutlookAction[] }) {
  return (
    <div className="sticky bottom-0 z-20 -mx-4 mt-5 border-t border-white/[0.08] bg-[#080d14]/94 px-3 pb-[max(0.75rem,var(--sab))] pt-2.5 shadow-[0_-12px_30px_rgba(3,7,12,0.32)] backdrop-blur-xl md:-mx-6">
