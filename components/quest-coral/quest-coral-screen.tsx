  ...
  return (
    <div className={cn("quest-coral-scope quest-coral-canvas relative flex min-h-0 flex-1 flex-col overflow-hidden", className)}>
      ...
      <button
        ...
        className="quest-coral-primary-button quest-coral-tap absolute bottom-5 right-4 z-10 flex h-12 items-center gap-1.5 rounded-full px-4 text-sm font-semibold text-white shadow-[0_10px_24px_rgba(255,122,89,0.30)]"
      >
