  ...
  return (
    <div className={cn("applications-scope applications-canvas relative flex min-h-0 flex-1 flex-col overflow-hidden", className)}>
      ...
      <button
        type="button"
        onClick={() => setInviteOpen(true)}
        className="applications-primary-button applications-tap absolute bottom-[max(calc(var(--sab)+2rem),24dvh)] right-4 z-10 flex h-14 w-14 items-center justify-center rounded-full text-white shadow-[0_10px_24px_rgba(37,99,235,0.30)]"
