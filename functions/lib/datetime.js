...
exports.APP_TIME_ZONE = void 0;
exports.todayIsoInAppZone = todayIsoInAppZone;
exports.isSameDayInAppZone = isSameDayInAppZone;
exports.getRelativeDayLabel = getRelativeDayLabel;
exports.formatTimeInAppZone = formatTimeInAppZone;
exports.formatDateInAppZone = formatDateInAppZone;
exports.formatDateTimeInAppZone = formatDateTimeInAppZone;
exports.formatCalendarDateLabel = formatCalendarDateLabel;
exports.mondayForDateInAppZone = mondayForDateInAppZone;
/**
 ...
 */
exports.APP_TIME_ZONE = "America/New_York";
/** "YYYY-MM-DD" for `date` as seen in APP_TIME_ZONE. */
function todayIsoInAppZone(date = new Date()) {
    return date.toLocaleDateString("en-CA", { timeZone: exports.APP_TIME_ZONE });
}
function isSameDayInAppZone(a, b) {
    return todayIsoInAppZone(a) === todayIsoInAppZone(b);
}
/** "Today" / "Yesterday" / weekday / short-date, cutoffs anchored to APP_TIME_ZONE. */
function getRelativeDayLabel(date, now = new Date()) {
    ...
    if (diffDays > 0 && diffDays < 7)
        return formatDateInAppZone(date, { weekday: "long" });
    return formatDateInAppZone(date, { month: "short", day: "numeric" });
}
function formatTimeInAppZone(date, options = { hour: "numeric", minute: "2-digit", hour12: false }) {
    return date.toLocaleTimeString("en-US", {
        ...options,
        timeZone: exports.APP_TIME_ZONE,
    });
}
function formatDateInAppZone(date, options = { month: "short", day: "numeric", year: "numeric" }) {
    return date.toLocaleDateString("en-US", { ...options, timeZone: exports.APP_TIME_ZONE });
}
function formatDateTimeInAppZone(date, options = { dateStyle: "long", timeStyle: "short" }) {
    return date.toLocaleString("en-US", { ...options, timeZone: exports.APP_TIME_ZONE });
}
/**
 ...
 */
function formatCalendarDateLabel(isoDate, options = { month: "short", day: "numeric" }) {
...
function mondayForDateInAppZone(date) {
